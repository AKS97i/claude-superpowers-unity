...
| Term | Definition |
| --- | --- |
| **Superpower** | A single AI Engineering System in this collection — a structured, repeatable methodology that gives an AI assistant the reasoning of a Unity expert for one job. Lives in `superpowers/<category>/<name>/`. |
...
| **`SKILL.md`** | The production-ready skill file rendering of a Superpower, using progressive disclosure. |
| **`prompt.md`** | The portable, self-contained Markdown rendering of a Superpower for any AI assistant. |
...
| **Triggering** | The skill system's decision to invoke a skill based on its `description`. Reliable triggering is a primary design goal. |
...
| **Ecosystem** | The family of sibling repositories sharing this architecture. See [ecosystem.md](ecosystem.md). |
